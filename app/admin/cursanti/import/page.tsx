...
import { parseStudentsText, invertName, cleanPhone, cleanCounty } from '@/lib/import-parse'
...
export default function ImportCursantiPage() {
  ...
  // Parserul e comun cu portalul de verificare (lib/import-parse).
  const parseText = (text: string): StudentRow[] => parseStudentsText(text, defaultClass)
